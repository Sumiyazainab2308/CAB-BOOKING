...
| :--- | :--- | :--- | :--- | :--- |
| **1. Onboarding** | Quick, frictionless login without typing lengthy credentials. | `Login.jsx` & `AuthContext.jsx` | Forgotten passwords or slow email verification during demos. | **1-Click Demo Login:** Instantly injects pre-seeded credentials (`sumiya@ucab.com`) and issues JWT session. |

...
// Default initial data when starting without MongoDB
const defaultData = {
    users: [
        {
            _id: 'user_1',
    ...
    admins: [
        {
            ...
            password: '$2b$10$AdminHashedPasswordOrDemo', // plain 'adminpassword' check supported in auth fallback
            createdAt: new Date().toISOString()
        }
    ],
    cars: [
        ...
        {
            _id: 'car_5',
            name: 'Hyundai Aura Compact Sedan',
            cabType: 'Sedan',
            pricePerKm: 12,
            baseFare: 50,
            seats: 4,
            plateNumber: 'DL 05 IJ 7890',
        ...
        {
            _id: 'car_6',
            name: 'Mahindra XUV700 Executive SUV',
            cabType: 'SUV',
            pricePerKm: 18,
            baseFare: 80,
            seats: 6,
            plateNumber: 'DL 06 KL 2345',
    ...
    bookings: [
        {
            ...
            dropLocation: 'Cyber Hub, DLF Phase 2, Gurgaon',
            bookingDate: new Date(Date.now() - 86400000 * 2).toLocaleString('en-US', { dateStyle: 'medium', timeStyle: 'short' }),
            distanceKm: 18,
            totalFare: 266,
            status: 'Completed',
            refreshmentsOrdered: true,
            donationMade: false,
            discountCode: 'UCAB20',
            discountAmount: 66,
            paymentMethod: 'Automatic Saved Card (Visa •••• 4242)',
            driverAssigned: {
                name: 'Vikram Sharma',
        ...
        },
        {
            ...
            bookingDate: new Date().toLocaleString('en-US', { dateStyle: 'medium', timeStyle: 'short' }),
            distanceKm: 14,
            totalFare: 332,
            status: 'Started',
            refreshmentsOrdered: false,
            donationMade: true,
            discountCode: '',
            discountAmount: 0,
            paymentMethod: 'Automatic Saved Card (Visa •••• 4242)',
...
const loadData = () => {
    try {
        ...
        console.error("Error reading data.json fallback store, resetting to default:", err.message);
        return defaultData;
    }
};

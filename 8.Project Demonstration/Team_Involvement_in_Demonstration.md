...
This project (`UCab`) was designed, engineered, tested, and documented completely by a single developer (`Sumiya Zainab / Pravanshu / Solo Track`). Rather than dividing workload across multiple team members, full-stack accountability was maintained across every layer of the application stack.
